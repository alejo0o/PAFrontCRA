                    ...
                    <tbody>
                        {this.state.data.map(respuesta=>(
                            <tr key={respuesta.respid}>
                                ...
                                <td>
                                <Button color="primary" onClick={()=>{this.seleccionar(respuesta); this.modalInsertar()}}></Button>
                                {"  "}
                                <Button color="danger" onClick={()=>{this.seleccionar(respuesta); this.setState({modalEliminar: true})}}></Button></td>
                            </tr>
                        ))}
                    </tbody>
                </Table>
